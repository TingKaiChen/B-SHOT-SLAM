...
namespace velodyne
{
    ...
    class HDL32ECapture : public VelodyneCapture
    {
        ...
        public:
            ...
            #ifdef HAVE_PCAP
            HDL32ECapture( const std::string& filename, int spframe ) : VelodyneCapture( filename )
            {
                initialize();
                VelodyneCapture::specifiedframe = spframe;
            };
            #endif
            ...
            inline std::vector<double> getVerticalAngle(){return lut;};
